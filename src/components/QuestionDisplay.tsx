  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="mt-6 grid grid-cols-2 *:mx-12 *:my-4 *:h-32 *:w-96 *:text-2xl">
        <Button text={gameCard.choices[0].answer} className="theme-blue" onclick={nextQuestion}/>
        <Button text={gameCard.choices[1].answer} className="theme-green" onclick={nextQuestion}/>
        <Button text={gameCard.choices[2].answer} className="bright-red" onclick={nextQuestion}/>
        <Button text={gameCard.choices[3].answer} className="theme-brown-dark" onclick={nextQuestion}/>
      </div>
